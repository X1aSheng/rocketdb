...
These files describe replayable workloads, not raw Flash partition dumps. For PC/server analysis of full KVDB or TSDB Flash images, use `tools/rdbdump`; see [offline_flash_analysis.md](../../docs/architecture/OFFLINE_ANALYSIS.md).
